...
from B_Model.EasyTSF.model.DenseRMoK import DenseRMoK
...
class Model(AbstactModel):
    ...
    def __init__(self, CTX:dict):
        ...
        # model definintion
        self.model = DenseRMoK(self.CTX["INPUT_LEN"], self.CTX["OUTPUT_LEN"], self.CTX["FEATURES_IN"], drop=self.dropout)
