...
from B_Model.EasyTSF.model.NLinear import NLinear
...
class Model(AbstactModel):
    ...
    def __init__(self, CTX:dict):
        ...
        # model definintion
        self.model = NLinear(self.CTX["INPUT_LEN"], self.CTX["OUTPUT_LEN"], self.CTX["FEATURES_IN"])
    ...
    def training_step(self, x:np.float32_3d[ax.sample, ax.time, ax.feature], y:np.float32_3d[ax.sample, ax.time, ax.feature]):
        # generate the training step equivalent to : 
