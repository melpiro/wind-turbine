...
class Model(AbstactModel):
    ...
    def __init__(self, CTX:dict):
        ...
        for i in range(self.CTX["LAYERS"]-1):
            z = LSTM(self.CTX["UNITS"], return_sequences=True, dropout=self.dropout)(z)
            
        if (self.CTX["SLIDING_WINDOW"]):
            z = LSTM(self.CTX["UNITS"], return_sequences=False, dropout=self.dropout)(z)
